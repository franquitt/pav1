...
namespace Ferreteria.Datasets {
    ...
    public partial class DS_Ventas : global::System.Data.DataSet {
        ...
        public partial class VENTASDataTable : global::System.Data.TypedTableBase<VENTASRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public VENTASRow AddVENTASRow(int vendedor, int cliente, System.DateTime fecha, decimal Total) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public VENTASRow FindBynumeroVenta(int numeroVenta) {
            ...
            private void InitClass() {
                ...
                this.columnnumeroVenta.AutoIncrement = true;
                this.columnnumeroVenta.AutoIncrementSeed = -1;
                this.columnnumeroVenta.AutoIncrementStep = -1;
                this.columnnumeroVenta.AllowDBNull = false;
                this.columnnumeroVenta.ReadOnly = true;
        ...
        public partial class VENTASRow : global::System.Data.DataRow {
            ...
            public int numeroVenta {
                get {
                    return ((int)(this[this.tableVENTAS.numeroVentaColumn]));
                }
                set {
                    this[this.tableVENTAS.numeroVentaColumn] = value;
                }
            }
            ...
            public int vendedor {
                get {
                    return ((int)(this[this.tableVENTAS.vendedorColumn]));
                }
                set {
...
namespace Ferreteria.Datasets.DS_VentasTableAdapters {
    ...
    public partial class VENTASTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        VENTAS.numeroVenta, VENTAS.vendedor, VENTAS.cliente, VENTAS.fecha, SUM(DETALLE_VENTA.precioVenta) AS Total
FROM            VENTAS INNER JOIN
                         DETALLE_VENTA ON VENTAS.numeroVenta = DETALLE_VENTA.numeroVenta AND VENTAS.numeroVenta = DETALLE_VENTA.numeroVenta AND VENTAS.numeroVenta = DETALLE_VENTA.numeroVenta
WHERE        (YEAR(VENTAS.fecha) = @x)
GROUP BY VENTAS.numeroVenta, VENTAS.vendedor, VENTAS.cliente, VENTAS.fecha";
        ...
        public virtual int Fill(DS_Ventas.VENTASDataTable dataTable, decimal x) {
        ...
        public virtual DS_Ventas.VENTASDataTable GetData(decimal x) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(x));
            DS_Ventas.VENTASDataTable dataTable = new DS_Ventas.VENTASDataTable();
